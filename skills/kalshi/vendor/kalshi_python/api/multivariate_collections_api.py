...
class MultivariateCollectionsApi:
    ...
    def get_multivariate_event_collections(
        ...
        :param status: Filter by multivariate collection status
        :type status: str
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
    ...
    def get_multivariate_event_collections_with_http_info(
        self,
        status: Annotated[Optional[StrictStr], Field(description="Filter by multivariate collection status")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
    ...
    @validate_call
    def lookup_multivariate_event_collection_bundle(
        self,
        collection_ticker: StrictStr,
        ...
        **kwargs: Any,
        ...
        :param collection_ticker: Collection ticker (required)
        :type collection_ticker: str
        :param lookup_bundle_request:  (required)
        :type lookup_bundle_request: LookupBundleRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        lookup_bundle_request = LookupBundleRequest(**kwargs) if kwargs else None

        _param = self._lookup_multivariate_event_collection_bundle_serialize(
            collection_ticker=collection_ticker,
            lookup_bundle_request=lookup_bundle_request,
    ...
    @validate_call
    def lookup_multivariate_event_collection_bundle_with_http_info(
        self,
        collection_ticker: Annotated[StrictStr, Field(description="Collection ticker")],
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[LookupBundleResponse]:
        """Lookup Multivariate Event Collection Bundle
    ...
    @validate_call
    def lookup_multivariate_event_collection_bundle_without_preload_content(
        self,
        collection_ticker: Annotated[StrictStr, Field(description="Collection ticker")],
        lookup_bundle_request: LookupBundleRequest,
        _request_timeout: Union[
    ...
    def _lookup_multivariate_event_collection_bundle_serialize(
        self,
        collection_ticker,
        lookup_bundle_request,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        # process the form parameters
        # process the body parameter
        if lookup_bundle_request is not None:
            _body_params = lookup_bundle_request
