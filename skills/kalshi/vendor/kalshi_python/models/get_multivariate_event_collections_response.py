...
class GetMultivariateEventCollectionsResponse(BaseModel):
    ...
    """ # noqa: E501
    collections: Optional[List[MultivariateEventCollection]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "collections": [MultivariateEventCollection.from_dict(_item) for _item in obj["collections"]] if obj.get("collections") is not None else None
        })
        return _obj
