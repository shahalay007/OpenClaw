...
class Settlement(BaseModel):
    ...
    yes_count: Optional[StrictInt] = None
    no_count: Optional[StrictInt] = None
    revenue: Optional[StrictInt] = None
    settled_time: Optional[datetime] = None
    __properties: ClassVar[List[str]] = ["ticker", "result", "yes_count", "no_count", "revenue", "settled_time"]
