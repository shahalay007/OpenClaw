...
class Event(BaseModel):
    ...
    sub_title: Optional[StrictStr] = None
    title: Optional[StrictStr] = None
    status: Optional[StrictStr] = None
    markets: Optional[List[Market]] = None
    __properties: ClassVar[List[str]] = ["event_ticker", "series_ticker", "sub_title", "title", "status", "markets"]
    ...
    def status_validate_enum(cls, value):
        ...
        if value not in set(['open', 'closed', 'settled']):
            raise ValueError("must be one of enum values ('open', 'closed', 'settled')")
        return value
