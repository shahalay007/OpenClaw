...
class StructuredTarget(BaseModel):
    ...
    StructuredTarget
    """ # noqa: E501
    structured_target_id: Optional[StrictStr] = None
    title: Optional[StrictStr] = None
    status: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["structured_target_id", "title", "status"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "structured_target_id": obj.get("structured_target_id"),
            "title": obj.get("title"),
