...
class GetExchangeScheduleResponse(BaseModel):
    ...
    """ # noqa: E501
    schedule: Optional[GetExchangeScheduleResponseSchedule] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GetExchangeScheduleResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GetExchangeScheduleResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "schedule": GetExchangeScheduleResponseSchedule.from_dict(obj["schedule"]) if obj.get("schedule") is not None else None
        })
        return _obj
