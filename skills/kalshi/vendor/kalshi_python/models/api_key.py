...
class ApiKey(BaseModel):
    ...
    created_ts: Optional[datetime] = Field(default=None, description="Timestamp when the API key was created")
    __properties: ClassVar[List[str]] = ["api_key_id", "name", "created_ts"]
