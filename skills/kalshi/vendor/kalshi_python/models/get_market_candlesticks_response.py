...
class GetMarketCandlesticksResponse(BaseModel):
    ...
    """ # noqa: E501
    candlesticks: Optional[List[Candlestick]] = None
    __properties: ClassVar[List[str]] = ["candlesticks"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GetMarketCandlesticksResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GetMarketCandlesticksResponse from a dict"""
        if obj is None:
            return None
