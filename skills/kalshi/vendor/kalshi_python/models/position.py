...
class Position(BaseModel):
    ...
    market_result: Optional[StrictStr] = None
    realized_pnl: Optional[StrictInt] = None
    resting_order_count: Optional[StrictInt] = None
    position: Optional[StrictInt] = None
    fees_paid: Optional[StrictInt] = None
    total_cost: Optional[StrictInt] = None
    __properties: ClassVar[List[str]] = ["ticker", "event_ticker", "market_result", "realized_pnl", "resting_order_count", "position", "fees_paid", "total_cost"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "resting_order_count": obj.get("resting_order_count"),
