...
class GetSeriesByTickerResponse(BaseModel):
    """
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GetSeriesByTickerResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GetSeriesByTickerResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "series": Series.from_dict(obj["series"]) if obj.get("series") is not None else None
        })
        return _obj
