...
class GetMarketsResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["markets", "cursor"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GetMarketsResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GetMarketsResponse from a dict"""
        if obj is None:
            return None
