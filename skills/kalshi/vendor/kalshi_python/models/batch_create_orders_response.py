...
class BatchCreateOrdersResponse(BaseModel):
    ...
    """ # noqa: E501
    responses: Optional[List[BatchCreateOrdersResponseResponsesInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "responses": [BatchCreateOrdersResponseResponsesInner.from_dict(_item) for _item in obj["responses"]] if obj.get("responses") is not None else None
        })
        return _obj
