...
class BatchCreateOrdersResponseResponsesInner(BaseModel):
    """
    BatchCreateOrdersResponseResponsesInner
    """ # noqa: E501
    order: Optional[Order] = None
    error: Optional[ErrorResponse] = None
    __properties: ClassVar[List[str]] = ["order", "error"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of BatchCreateOrdersResponseResponsesInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of BatchCreateOrdersResponseResponsesInner from a dict"""
        if obj is None:
            return None
