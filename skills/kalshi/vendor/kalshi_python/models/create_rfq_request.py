...
class CreateRFQRequest(BaseModel):
    ...
    expires_in_seconds: Optional[Annotated[int, Field(le=3600, strict=True, ge=60)]] = None
    __properties: ClassVar[List[str]] = ["ticker", "side", "size", "expires_in_seconds"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CreateRFQRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CreateRFQRequest from a dict"""
        if obj is None:
            return None
