...
class GetMultivariateEventCollectionResponse(BaseModel):
    ...
    """ # noqa: E501
    collection: Optional[MultivariateEventCollection] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GetMultivariateEventCollectionResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GetMultivariateEventCollectionResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "collection": MultivariateEventCollection.from_dict(obj["collection"]) if obj.get("collection") is not None else None
        })
        return _obj
