...
class BatchCancelOrdersResponse(BaseModel):
    ...
    """ # noqa: E501
    responses: Optional[List[BatchCancelOrdersResponseResponsesInner]] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of BatchCancelOrdersResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of BatchCancelOrdersResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "responses": [BatchCancelOrdersResponseResponsesInner.from_dict(_item) for _item in obj["responses"]] if obj.get("responses") is not None else None
        })
        return _obj
